...
#ifndef GOOGLESQL_ANALYZER_GRAPH_EXPR_RESOLVER_HELPER_H_
#define GOOGLESQL_ANALYZER_GRAPH_EXPR_RESOLVER_HELPER_H_
...
#endif  // GOOGLESQL_ANALYZER_GRAPH_EXPR_RESOLVER_HELPER_H_
